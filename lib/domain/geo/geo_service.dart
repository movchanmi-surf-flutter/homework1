...
abstract class GeoService {
  ...
  static bool isPositionInArea(
      {required Position currPosition,
      required double latitude,
      required double longtitude,
      required double maxRadius,
      required double minRadius}) {
    return Geolocator.distanceBetween(currPosition.latitude,
                currPosition.longitude, latitude, longtitude) <=
            maxRadius &&
        Geolocator.distanceBetween(currPosition.latitude,
                currPosition.longitude, latitude, longtitude) >=
            minRadius;
  }
}
